...
Properties
	{
		_Color("Main Color", Color) = (0.6,0.05,0,1)
		_MainTex("Texture", 2D) = "white" {}

		_FirstOutlineColor("Outline color", Color) = (0.1, 0.2, 0.7)
		_FirstOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.1

		_SecondOutlineColor("Outline color", Color) =  (0.1, 0.2, 0.7)
		_SecondOutlineWidth("Outlines width", Range(0.0, 2.0)) = 0.1
